...
viewpoint_file = 'banana_viewpoints_45.pkl'
...
# Pose real object
translation_real = np.array([0.1,0.1,1.2]) # position of the object in meters wrt camera
...
translation_cad = compute_object_center(object_pixels, 0.9, camera_intrinsic)
